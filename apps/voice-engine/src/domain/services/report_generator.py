...
Generates a NanoID review token, computes overall confidence, and persists
claim data to the assessment_sessions.claims_json column.
"""
...
class ReportGenerator:
    ...
    async def generate(
        ...
        review_token = nanoid_generate(_NANOID_ALPHABET, _NANOID_LENGTH)
        ...
        logger.info(
            "ReportGenerator: report saved for session %s — %d claims, token=%s",
            session_id,
